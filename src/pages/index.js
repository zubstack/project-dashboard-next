        ...
        <div className="mx-auto max-w-2xl py-0 sm:py-0 lg:py-0">
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="/login"
                className="rounded-md bg-cafe-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-cafe-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Get started
              </a>
            </div>
